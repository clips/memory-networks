...
class N2NInspect(N2N):
    def __init__(self, batch_size, embed_size, vocab_size, hops, story_size, args, word_idx):
        super().__init__(batch_size, embed_size, vocab_size, hops, story_size, args, word_idx)
    ...
    def forward(self, trainS, trainQ, trainVM, trainPM, trainSM, trainQM):
        ...
        w_u, att_probs = self.hop(S, queries_sum, self.A1, self.A2, trainPM, trainSM)  # , self.TA, self.TA2)
